...
export default function LoginForm() {
  ...
  return (
    <>
      ...
      <div style={divider} />
      <p style={muted}>
        Need an account? Use the existing SahYog Role Persona → Supabase Auth signup flow.
        Administrator accounts are created/promoted by the platform owner and cannot be self-created.
      </p>
